...
setup(
    ...
    version='1.0.1',
    author='Ihar Nauros',
    author_email='inauros@copyright.com',
    description='Test project for PyGradle',
    url='https://github.com/inauros/PyGradle-test',
    license='Copyright (C) 2018 copyright.com',
